...
namespace TicketingSystem.Controllers
{
    ...
    public class OrderDiscountsController : ControllerBase
    {
        ...
        public OrderDiscountsController(IOrderDiscountService discountService)
        {
        ...
        /// </summary>
        [HttpPost("ApplyOrderDiscount")]
        public async Task<ActionResult<DiscountResultDto>> ApplyOrderDiscount([FromBody] ApplyOrderDiscountDto applyDiscountDto)
        {
            try
            {
                ...
                if(applyDiscountDto.OrderId.HasValue == false)
                    return BadRequest(ModelState);
                var discountAmount = await _discountService.ApplyOrderDiscountAsync(
                    applyDiscountDto.Code,
                    applyDiscountDto.OrderId.Value);
        ...
        private static DiscountCodeDto MapToDiscountCodeDto(OrderDiscountCode discountCode)
        {
